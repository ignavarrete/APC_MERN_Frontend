  ...
  useEffect( () => {
    const comprobarToken = async () => {
      try {
        ...
        setAlerta({
          msg: 'Ups!, hubo un error con el enlace',
          error: true
        })
      }
    }
          ...
          <>
            <form onSubmit={handleSubmit}>
              <div className="my-5">
                ...
                <input type="password" placeholder="Tu nuevo password" autoComplete="on" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" 
                value={password} 
